...
import AddCourseReview from "./pages/Courses/AddCourseReview";
    ...
    <React.Fragment>
      ...
      <Route path="navbar" element={<Navbar />}>
        ...
        <Route path="course">
          ...
          <Route
            path="/navbar/course/update/:courseid"
        ...
        <Route path="student">
          ...
          <Route
            path="/navbar/student/update/:studentid"
            element={<UpdateStudent />}
          />
          <Route
            path="review/:courseID/:courseTitle/:courseDesc/:maxStudents/:coures"
            element={<ReviewStudent />}
          />
          <Route
            path="/navbar/student/delete/:studentid"
            element={<DeleteStudent />}
          />
          <Route
            path="addreview/:courseID/:courseTitle/:courseDesc/:maxStudents/:selectCourses/:coursesCount"
            element={<AddReviewStudent />}
          />
          <Route
            path="/navbar/student/view/:studentid"
            element={<ViewStudent />}
          />
        </Route>
      </Route>
