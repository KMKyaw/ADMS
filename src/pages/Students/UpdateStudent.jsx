  ...
  const getData = async () => {
    try {
      const response = await Axios.post(
        "http://localhost:5000/student/getData/specific",
        {
          studentId: studentid,
        }
      );
              ...
              <div class="grid gap-6 mb-6 md:grid-cols-2">
                <div className="px-4 pt-4">
                  ...
                  <input
                    ...
                    defaultValue={
                      studentData.length ? studentData[0].firstname : ""
                    }
                    type="text"
                    id="course_id"
                ...
                <div className="px-4 md:pt-4">
                  ...
                  <input
                    ...
                    defaultValue={
                      studentData.length ? studentData[0].lastname : ""
                    }
                    type="text"
                    id="course_title"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              ...
              <div class="mb-6">
                <div className="px-4 md:pt-4">
                  ...
                  <input
                    ...
                    defaultValue={
                      studentData.length ? studentData[0].studentid : ""
                    }
                    type="text"
                    id="course_desc"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              ...
              <div class="mb-6">
                <div className="px-4 md:pt-4">
                  ...
                  <input
                    ...
                    defaultValue={studentData.length ? studentData[0].gpax : ""}
                    step="any"
                    type="number"
                    id="max_students"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
