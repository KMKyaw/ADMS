  ...
  const handleClickDelete = async () => {
    try {
      const response = await Axios.delete(
        "http://localhost:5000/course/delete/specific",
        {
          data: {
            courseid: courseID,
          },
          ...
          <div className="pb-4 pr-1 self-end">
            ...
            <div className="pb-3 pr-3 float-right">
              <button
                ...
                className="shadow-md border-2 text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-md px-3 py-2.5 mr-2 mb-2 focus:outline-none "
              >
                <span>DELETE</span>
              </button>
            </div>
                  ...
                  <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                    ...
                    <div class="mt-2">
                      <p class="text-sm text-gray-500">
                        Deleted data will not be able to recovered
                      </p>
                    </div>
                  </div>
                </div>
