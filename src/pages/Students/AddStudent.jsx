            ...
            <div className="pt-4">
                <div className="m-auto md:w-[99%] w-[96%] border-2 relative shadow-md">
                    <form className="flex flex-col">
                        ...
                        <div class="mb-6">
                            <div className="px-4 md:pt-4">
                                {/* <label for="first_name" class="block mb-2 text-[20px] font-medium whitespace-nowrap text-navbar">Course</label>
                                ...
                                <label for="countries" class="block mb-2 text-[20px] font-medium whitespace-nowrap text-navbar">Course</label>
